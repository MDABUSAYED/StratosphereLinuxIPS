...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 17 20:33:31 2024
...
df_type1 = df[df['Type'] == 1]
df_type2 = df[df['Type'] == 0]
...
model_name = "meta-llama/Meta-Llama-3-8B" # "unsloth/llama-3-8b-bnb-4bit" #"HuggingFaceH4/zephyr-7b-beta" # "meta-llama/Meta-Llama-3-8B" #'distilbert-base-uncased'
...
print('Finetuned Q-lora on llama3 model performance on different matrics\n')
